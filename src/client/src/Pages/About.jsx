  ...
  return (
    <div className="contenedor">
      ...
      <div className="texto">
        ...
        <p className="cuerpo">
          En IDW Check In, estamos dedicados a simplificar tu proceso de
          ...
          sea rápida, eficiente y sin estrés. En I DW, nos comprometemos a
          ...
          fluida y agradable posible. Confía en IDW Check In para brindarte un
